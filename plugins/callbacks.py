...
@Client.on_callback_query(filters.regex("^(manage_clones|clone|toggle_fsub|toggle_autodel|toggle_filestore|toggle_stream)$"))
async def placeholder_callbacks(client, query: CallbackQuery):
