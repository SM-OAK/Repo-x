...
# NOTE: Is user_states ko hum baad mein ek central file (input_handler.py) mein move karenge.
# Abhi ke liye ise yahin rehne dein.
user_states = {}
...
￼Enter# plugins/clone_customize/appearance.py
from pyrogram import Client, filters
from pyrogram.types import CallbackQuery, InlineKeyboardMarkup, InlineKeyboardButton
from database.clone_db import clone_db
import logging
